...
def save_eval_val(webpage, aver_psnr, aver_ssim):
    webpage.add_header("final PNSR : {:.2f}, SSIM : {:.2f}".format(aver_psnr, aver_ssim))

def save_images(webpage, visuals, image_path, psnr, ssim, aspect_ratio=1.0, width=256):
    ...
    webpage.add_header("{}  PSNR: {} SSIM: {}".format(name, psnr, ssim))
    ims, txts, links = [], [], []
